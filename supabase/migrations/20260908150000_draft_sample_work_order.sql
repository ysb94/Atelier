-- 기획안 1차 샘플 작업 지시서. 사진과 같이 data URL로 저장한다.
...
comment on column public.product_drafts.sample_work_order_url is
  '1차 샘플 작업 지시서 data URL. 없으면 null.';
comment on column public.product_drafts.sample_work_order_name is
  '1차 샘플 작업 지시서 원본 파일명';
